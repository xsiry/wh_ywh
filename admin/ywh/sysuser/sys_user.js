(function($){
    ...
    var pageListGrid = {
		...
		this.grid = $(self.main).ligerGrid({ 
         	columns: [      
         	        { display: '用户姓名', name: 'sysname' ,width:160}, 
         	        { display: '账户', name: 'username' ,width:160 }, 
         	        { display: '可见分组', name:'sysusergroupnames', width:160 ,isSort:false },
         	        { display: '权限', name: 'authority'  ,isSort:false, render: function (rowdata, rowindex, value){
         	        	if (value){
         	        ...
         	        { display: '用户状态', name: 'ustate',width:100  , render: function (rowdata, rowindex, value){
         	        	 if (value=='1')
	                ...
	                { display: '操作',width:230, render: function (rowdata, rowindex, value){
						var h = ""; 
						if (rowdata.ustate=="1")
	           ...
	           pageSizeOptions:[20,30,50], sortName: 'sysusid',sortOrder:'ASC',  enabledSort:true, 
	...
	var getPassRow = function(showtype){
		if (showtype=='all'){
			return [ 
				    ...
				    {display:"员工权限",name:"authority",newline:true,validate:{required:false},type:"checkboxlist",comboboxName: "authority",options:{rowSize:4,
					data:[{text:'远程网吧',id:'Remote_Netbar'},{ text: '下载游戏', id: 'Download_Game'},{ text: '详情查看', id: 'Details_View'},{ text: '开机任务', id: 'Boot_Task'},{ text: '安全策略', id:'Security_Policy'},{ text: '信息发布', id: 'Information_Delivery'}] ,width:120 },width:450
				    } 
