(function($){
    ...
    var pageListGrid = {
		...
		this.grid = $(self.main).ligerGrid({ 
         	columns: [  
	                { display: '游戏名称', name: 'gamename'},
	                { display: '游戏分类', name: 'classtype',width:100 },	                
	                { display: '游戏大小', name: 'size' ,width:90},  
	                { display: '热门值', name: 'hot',width:60},
	                { display: '更新时间', name: 'updatetime' ,width:140},
	                { display: '添加下载',  width:100  ,isSort:false,render:function (rowdata, rowindex, value){
