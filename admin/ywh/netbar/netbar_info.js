...
(function($){
    ...
    var pageBindingAction = function () {
	    ...
	    $root.on("click", '.ycdesktopimg_abtn', function(actionobj) {
	       ...
	       620,160,350,function(){},{"netbarid":netbarid});
	       actionobj.preventDefault();
		   rowobj = null ;
	    }) ;
    ...
    var remoteNetbar = function (){
    	if  ( (userAccInfo_authority=='ALL') ||
    		...
    		return  { display: '远程管理',  width:100  ,isSort:false ,render:function (rowdata, rowindex, value){
    ...
    var detailsView = function (){
    	if  ( (userAccInfo_authority=='ALL') ||
    		...
    		return  { display: '详情', name: 'ucid_total' ,width:100 ,isSort:false,render:function (rowdata, rowindex, value){
    ...
    var downloadGame = function (){
    	if  ( (userAccInfo_authority=='ALL') ||
    		...
    		return   { display: '游戏下载',  width:100  ,isSort:false,render:function (rowdata, rowindex, value){
    ...
    var pageListGrid = {
		...
		this.grid = $(self.main).ligerGrid({
         	columns: [
	                { display: '网吧账号', name: 'netbaracc' ,width:160 },
	                { display: '网吧名称', name: 'netbarname'},
	                { display: '登录IP', name: 'netbarregip' ,width:160},
	                { display: '机器台数', name: 'netbaractivationterminal',width:80},
	                { display: '所属分组', name: 'groupname' ,width:120  ,isSort:false},
	                remoteNetbar(),
	                downloadGame(),
	                detailsView()
			    ],
	           ...
	           pageSizeOptions:[ 30,50,100], sortName: 'netbarid',sortOrder:'ASC',  enabledSort:true,
